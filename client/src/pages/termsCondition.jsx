      ...
      <div className="font-inter mb-20">
        <div>
          <div className="max-w-5xl mx-auto p-6">
            <p className="mb-4">
              Welcome to Automall ! Before you start shopping, please take a
            ...
            <p className="mb-4">
              By accessing or using the Automall website, you agree to comply
            ...
            <p className="mb-4">
              All content on the Automall website, including text, graphics,
            ...
            <p className="mb-4">
              Automall is not liable for any indirect, incidental, or
