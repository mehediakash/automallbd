      ...
      {products.length > 0 ? (
        <div className="pb-20">
          ...
          <button
            ...
            className="py-2 px-10 bg-black text-white font-semibold uppercase mb-4 hover:bg-primary duration-300"
          >
            Reset cart
          </button>
          ...
          <div className="max-w-7xl gap-4 flex justify-end mt-4">
            <div className="w-96 flex flex-col gap-4">
              ...
              <div className="flex justify-end">
                <Link to="/checkout">
                  <button className="w-52 h-10 bg-primary text-white  duration-300">
                    Proceed to Checkout
                  </button>
                </Link>
              </div>
